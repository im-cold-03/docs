---
title: "Welcome to Freshco."
description: "We welcome you to Freshco - The future of Roblox shopping. In this documentation, you will find important information regarding Freshco."
---

## Links

All official links owned by Freshco are listed below. Any other links are fake.

<Card title="Guidelines" icon="clipboard-check" horizontal={false} href="/guidelines">
  All guidelines and rules for both the Roblox Game & our Discord server are listed here.
</Card>

<Card title="Discord" icon="message-lines" horizontal={false} href="https://discord.gg/G7rRfRmp3A">
  The Freshco Discord server.
</Card>
